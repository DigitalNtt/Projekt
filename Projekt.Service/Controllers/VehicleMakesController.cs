...
namespace Projekt.Service
{
    public class VehicleMakeController : Controller
    {
        ...
        //public async Task<ActionResult> Edit([Bind(Include = "Id,ClanskiBroj,Prezime,Ime,OIB,MjestoRodjenja,DatumRodjenja,MjestoPrebivalista,Adresa,Telefon,SadasnjeZaposlenje,Email,WebStranica,PodrucjeInteresa,DatumUclanjenja,Status")] VehicleMakeViewModel vehicleMake)
        //{
